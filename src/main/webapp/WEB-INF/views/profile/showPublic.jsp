	...
	<div class="row profilBox">
		...
		<div class="col-xs-6 col-sm-6">
			<div class="information-input">
				<div id="send-buttons"
					style="display: ${!confirmSoulmatesRequest ? 'block' : 'none'}">
					<button class="btn btn-primary" data-personid="${person.id}" id="send-soulmates-request"
						style="display: ${!isSoulmatesRequestSent ? 'block' : 'none'}">
						<spring:message code="profile.show.soulmates.button.addSoulmate" />
					</button>

					<span id="sent-soulmates-request"
						style="display: ${isSoulmatesRequestSent ? 'block' : 'none'}">
						<spring:message
							code="profile.show.soulmates.soulmatesRequestPending" />
						<button class="btn btn-warning" data-personid="${person.id}" id="cancel-soulmates-request">
							<spring:message
								code="profile.show.soulmates.button.cancelSoulmatesRequest" />
						</button>
					</span>
				</div>
				...
				<div id="confirm-buttons"
					style="display: ${confirmSoulmatesRequest ? 'block' : 'none'}">
					<button class="btn btn-success" data-personid="${person.id}" id="confirm-soulmates-request">
						<spring:message
							code="profile.show.soulmates.button.confirmSoulmatesRequest" />
					</button>
					<button class="btn btn-danger" data-personid="${person.id}" id="cancel-soulmates-request">
						<spring:message
							code="profile.show.soulmates.button.declineSoulmatesRequest" />
					</button>
				</div>

				<button data-personid="${person.id}" id="block-person"
	...
	<div class="right-content">
		...
		<div class="content">
			...
			<div class="numbers" style="border-bottom: 0px solid #eee;">
				...
				<div class="numbers-column">
					<span class="number"><c:out value="${numberOfSoulmates}" /></span>
